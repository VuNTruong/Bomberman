...
public class ShieldCreator : MonoBehaviour
{
    ...
    // Array of positions not to instantiate the shield
    ...
    void Update()
    {
        // Decrement the number of frame every frame count
        numOfFrame -= 1;
        ...
        if (numOfFrame == 0)
        {
            ...
            // Instantiate
            Instantiate(shield, position, Quaternion.Euler(0, 0, 0));

            // Bring the number of frame back to 500
            numOfFrame = 500;
        }
    }
}
